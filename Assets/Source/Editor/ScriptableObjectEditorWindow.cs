...
/// <summary>
/// ScriptableObjectEditorWindow class
/// The Editor window for creating Unity Scriptable Objects
/// </summary>
public class ScriptableObjectEditorWindow : EditorWindow
{
    ...
    public static void Init(Type[] scriptableObjects)
    {
        ...
        var window = GetWindow<ScriptableObjectEditorWindow>(true, "Create a new ScriptableObject", true);
        window.ShowPopup();
    }
