...
public class Lv02MaxBackAscLevel : Lv02BaseLevel
{
    ...
    public override void CheckSolution()
    {
        ...
        bool result = GameController.instance.gameRules.IsMaxBack(temp) &&
            GameController.instance.gameRules.IsAscending(temp);
        if (!result)
        {
            isSolved = false;
            return;
