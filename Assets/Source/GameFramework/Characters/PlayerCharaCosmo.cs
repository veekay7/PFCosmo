...
public class PlayerCharaCosmo : Character
{
    ...
    [SerializeField]
    private MdlCosmo m_mdlCosmo = null;
    [SerializeField]
    ...
    public MdlCosmo mdlCosmo => m_mdlCosmo;
    ...
    protected override void Start()
    {
        ...
        m_mdlCosmo.animBehaviour.owner = this;
    ...
    public UnityEngine.Events.UnityEvent onHitPlatform = new UnityEvent();
    ...
    private void CheckForPlatform(RaycastHit2D hit)
    {
        ...
        m_pPlatform = p;
        m_platformPosition = m_pPlatform.position;
        PlayerHudCanvas.instance.CosmoSay("You're at Index " + "& Node Value is  " +p.value);

        if (onHitPlatform != null)
            onHitPlatform.Invoke();
